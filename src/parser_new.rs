...
pub fn type_<'t>(lex: &mut Lex<'t>) -> ParseResult<'t, Option<Type<'t>>> {
  fn peek_term<'t>(lex: &mut Lex<'t>) -> ParseResult<'t, Option<Type<'t>>> {
...
pub fn def<'t>(lex: &mut Lex<'t>) -> ParseResult<'t, Def<'t>> {
  fn def_<'t>(lex: &mut Lex<'t>) -> ParseResult<'t, Option<Def<'t>>> {
    let start = lex.span();
  ...
  fn ty_<'t>(lex: &mut Lex<'t>) -> ParseResult<'t, Option<Def<'t>>> {
    let start = lex.span();
  ...
  fn enum_<'t>(lex: &mut Lex<'t>) -> ParseResult<'t, Option<Def<'t>>> {
    let start = lex.span();
    ...
    fn enum_const<'t>(lex: &mut Lex<'t>) -> ParseResult<'t, EnumConst<'t>> {
      let start = lex.span();
      let name = match expect!(
        lex,
        Token::ProperName(_),
