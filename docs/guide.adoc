...
The `ret` keyword may be omitted if the last statement in the function is an
expression. Then the result of the function is the result of the last
expression.
...
This can be used for readable one-liners combined with the iterator functions.
