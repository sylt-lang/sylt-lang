...
These types are the building blocks of the type system.
...
1 + definitely_a_number // Will compile, but is undefined behaviour.
----

Use forced types sparingly and only when you are 100% sure the program is
correct.
